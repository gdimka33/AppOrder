...
class СписокСотрудников(ttk.Frame):
    ...
    def _проверить_наличие_записей(self):
        """Проверяет наличие записей в базе данных для выбранного типа сотрудников"""
        try:
    ...
    def _добавить_сотрудника(self):
        ...
        # TODO: Реализовать добавление сотрудника
    ...
    def _добавить_из_файла(self):
        ...
        # TODO: Реализовать добавление из файла
        logger.info(f"Запрошено добавление {self.тип_сотрудника} из файла")
